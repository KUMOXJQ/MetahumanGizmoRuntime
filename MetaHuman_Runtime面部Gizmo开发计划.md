...
| 项 | 说明 |
|----|------|
| 描述文件 | `MetahumanGizmoRuntime.uplugin`（依赖 `MetaHumanCoreTech`、`MetaHumanSDK`、`MetaHumanCharacter`、`RigLogic`） |
...
*文档版本随 `MetahumanGizmoRuntime` 实现迭代；基准：UE 5.7、`Engine/Plugins/MetaHuman/`。*
